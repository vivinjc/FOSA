...
\begin{enumerate}
\item \textbf{Alert oracle}: The source code of the subject programs on which the static analysis alert are generated are examined. This is done so that a response set can be created for avoiding the false positives.
...
\begin{table*}[htbp]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|c|c|c|c|}
			...
			FAULTBENCH & Possible & No information & Possible  \\ \hline
...
The main idea, of this paper is to look into various available tools for static analysis bench-marking. Analyze strengths,weaknesses, and possible future enhancements of tools individually. It is can be possibly summarized through a quick look over in two tables show above.  
