...
\begin{tabular}{|c|p{3cm}|p{2cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
	...
	Hermess & No, sufficient information is available on the public availability of the benchmark & Yes & Yes, it is well defined benchmark framework & Yes, it covers the entirety of tests   & Yes, it solves the problem at hand  & Yes & Yes, as it supports further query specifications & No, as it currently supports only java bytecode  \\ \hline
